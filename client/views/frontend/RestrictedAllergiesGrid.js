...
const mapState = (state) => {
    const { restaurant, categories, selectedAllergies, setSelectedAllergy } = state.frontend;
    return {
      restaurant,
      categories,
      selectedAllergies,
  ...
  export default connect(mapState, mapDispatchToProps)(RestrictedAllergiesGrid);
