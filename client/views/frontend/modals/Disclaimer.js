...
const Disclaimer = ({
  ...
  return (
    ...
    <Container className="disclaimer-container top-box-shadow" >
        <h3 style={{margin: "0", paddingBottom: "10px"}}>DISCLAIMER</h3>
  ...
  if( obj.scrollTop === (obj.scrollHeight - obj.offsetHeight))
    {
      ...
      document.getElementById('show-menu-button-error').innerHTML = "Thanks! Click See Menu to view your personalized menu items."
      document.getElementById('scroll-disclaimer').style.boxShadow="inset 0 0 3px green "
      document.getElementById('show-menu-button-error').style.order = "5!important"
    } 
}
