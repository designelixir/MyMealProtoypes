...
const MenuItemCard = ({ menuitem, type, selectedAllergies, primaryColor }) => {
  ...
  return (
    <div className="menu-item-card-container">
      ...
      <div className="menu-item-card-image-container" style={{backgroundImage: `url(${menuitem.image ? menuitem.image.url : menuitem.ingredients})`}} onClick={function() {!modalShow && setModalShow(true)}}></div>
